...
print('fused_bias_act.cpp path={}'.format(os.path.join(module_path, "fused_bias_act.cpp")))
print('fused_bias_act_kernel.cu path={}'.format(os.path.join(module_path, "fused_bias_act_kernel.cu")))
fused = load(
    "fused",
    sources=[
